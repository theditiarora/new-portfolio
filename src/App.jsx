    ...
    <div className="min-h-screen min-w-screen pb-5 bg-[url(./imgs/purple-circles.png)] bg-cover font-rob">
      ...
      <div className="px-5 xs:px-10 md:px-20 my-16 xs:flex gap-10 md:gap-16">
        ...
        <div className="mt-7 xs:mt-1">
          ...
          <p className='font-rob font-medium lg:1/4 md:w-3/4 xl:w-2/4 mt-1 sm:mt-3 md:mt-5 lg:mt-10 text-xs sm:text-sm md:text-md-lg lg:text-lg'>Hey, I'm a Front-end developer with sweet design skills. I've been working with ReactJs for 2 years now while always down to explore the ins and outs of web dev. Right now, I'm focusing on learning Firebase and build projects on top of NextJS + TypeScript + firebase next. When I'm not coding, you can catch me painting or flipping through some books.
